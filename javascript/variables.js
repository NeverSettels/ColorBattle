    ...
    function titleAppear(){     
      ...
      function checkCollition() {
          if (player1.isTouching(bomb)) {
            ...
            if(player1.i != bomb.length-1 && player1.j != bomb.length-1) mapLarge.arrOutter[player1.i+1][player1.j+1] = "p1"
            ...
            ctx.clearRect(player1.x-player1.blockSize, player1.y-player1.blockSize,player1.blockSize*3,player1.blockSize*3)
            ctx.fillRect(player1.x-player1.blockSize, player1.y-player1.blockSize,player1.blockSize*3,player1.blockSize*3)
            bomb.draw()
          }
            ...
            if(player2.i != bomb.length-1 && player2.j != bomb.length-1) mapLarge.arrOutter[player2.i+1][player2.j+1] = "p2"
            ...
            ctx.clearRect(player2.x-player2.blockSize, player2.y-player2.blockSize,player2.blockSize*3,player2.blockSize*3)
            ctx.fillRect(player2.x-player2.blockSize, player2.y-player2.blockSize,player2.blockSize*3,player2.blockSize*3)
            bomb.draw()
          }
        }
